...
/*   Updated: 2025/01/07 18:54:53 by dstinghe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

bool						is_input_valid(t_philo_data *data, size_t ac,
								char **av);

static void					init_input_data(t_philo_data *data, size_t index,
								size_t input);
static t_invalid_input_type	is_valid_number(char *num, int64_t nb);
static void					print_input_error(t_invalid_input_type error_type,
								size_t ac, char *arg);
...
static void	print_input_error(t_invalid_input_type error_type, size_t ac,
		char *arg)
{
